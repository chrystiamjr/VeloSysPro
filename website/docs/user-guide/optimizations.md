...
- **Gaming Preset**: A curated starting point you opt into — foreground scheduler priorities, multimedia network throttling, fullscreen behaviour, the high-performance power plan, and three background services moved to Manual start. Every entry stays individually selectable and reversible.
